    ...
    return (
        <div
            className={`${style.container} ${
                item.clubname === "Liverpool" ? style.liverpool : ""
            }`}
        >
            <div className={style.ranking}>
                ...
                <div className={style.clubLogo}>
                    {item.logoImage !== "" ? (
                        ...
                        <Image
                            src="https://raw.githubusercontent.com/divclasssg/images/31b93daa87e490afe375cff7e9a5d23908d4949b/bls/lfc/logo_clubs_small/liverpoolfc_crest%201.svg"
                            alt="liverpool"
                            width={40}
                            height={72.727}
